#ifndef NL_GLX_GX_FLOAT_TEXTURED_COLOUR_MATERIAL_PROGRAM_H
#define NL_GLX_GX_FLOAT_TEXTURED_COLOUR_MATERIAL_PROGRAM_H

#include "NL/gl/glModel.h"
#include "NL/glx/GXMaterialProgramBase.h"

struct GXFloatTexturedColourParameters
{
    /* 0x00 */ glTextureBinding diffuseTexture;
}; // size: 0x8

class GXFloatTexturedColourMaterialProgram : public GXMaterialProgramImpl<GXFloatTexturedColourMaterialProgram>
{
public:
    GXFloatTexturedColourMaterialProgram();
    virtual ~GXFloatTexturedColourMaterialProgram();
    ...
    static GXFloatTexturedColourMaterialProgram* Instance;
    static bool Initialized;
    static GXMaterialParameter Parameters[1];
};

#endif // NL_GLX_GX_FLOAT_TEXTURED_COLOUR_MATERIAL_PROGRAM_H
