...
void Pane::SetName(const char* name) { strncpy(mName, name, sizeof(mName)); }

void Pane::SetUserData(const char* userData) { strncpy(mUserData, userData, sizeof(mUserData)); }
...
void Pane::UnbindAllAnimation(bool bRecursive) { UnbindAnimation(NULL, bRecursive); }
