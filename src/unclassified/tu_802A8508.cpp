...
extern "C" void fn_802A8508(State_802A8508* writer)
{
    writer->count = 0;
    writer->model = 0;
    writer->resource = 0;
...
extern "C" void* fn_802A8528(
    State_802A8508* writer, int shouldDelete)
{
...
extern "C" bool fn_802A8568(State_802A8508* writer,
    int vertexCount, int primitive, void* allocator)
{
    ...
    fn_802D38A4(
        writer->model, vertexCount, primitive, allocator, 3, 0x0027BCF6);
...
extern "C" bool fn_802A8714(State_802A8508* writer)
{
    u32 offset = 0;
    u32 i = 0;
