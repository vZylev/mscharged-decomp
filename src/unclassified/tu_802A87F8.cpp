...
extern "C" void* fn_802A8814(
    State_802A87F8* writer, int shouldDelete)
{
...
extern "C" bool fn_802A8854(State_802A87F8* writer,
    int vertexCount, int primitive, void* allocator)
{
    ...
    fn_802D38A4(
        writer->model, vertexCount, primitive, allocator, 2, 0xD701656B);
...
extern "C" bool fn_802A89AC(State_802A87F8* writer)
{
    u32 offset = 0;
    u32 i = 0;
