...
extern "C" void fn_80261CE0()
{
    ...
    info->mNoCheatSettings.unknown_0x00 = payload->mGameplaySettings.SkillLevel;
    info->mNoCheatSettings.unknown_0x04 = payload->mGameplaySettings.m_unk04;
    info->mNoCheatSettings.unknown_0x08 = payload->mGameplaySettings.GameTime;
    info->mNoCheatSettings.unknown_0x0C = payload->mGameplaySettings.m_unk0C;
    info->mNoCheatSettings.unknown_0x10 = payload->mGameplaySettings.m_unk10;
    info->mNoCheatSettings.unknown_0x14 = payload->mGameplaySettings.PowerUps;
    info->mNoCheatSettings.unknown_0x15 = payload->mGameplaySettings.Shoot2Score;
    info->mNoCheatSettings.unknown_0x16 = payload->mGameplaySettings.BowserAttackEnabled;
    info->mNoCheatSettings.unknown_0x17 = payload->mGameplaySettings.RumbleEnabled;
    info->mNoCheatSettings.unknown_0x18 = payload->mGameplaySettings.m_unk18;
    info->mNoCheatSettings.unknown_0x19 = payload->mGameplaySettings.m_unk19;
    info->mNoCheatSettings.unknown_0x1A = payload->mGameplaySettings.m_unk1A;
    info->mRulesA.unknown_0x0 = payload->mPowerupSettings.m_unk0;
    info->mRulesA.unknown_0x4 = payload->mPowerupSettings.m_unk4;
    info->mRulesA.unknown_0x8 = payload->mPowerupSettings.m_unk8;
