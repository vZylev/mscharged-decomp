...
inline void lineClosestApproach (const dVector3 pa, const dVector3 ua,
		...
		dContactGeom *contact, int skip)
{
  ...
  const dReal *normalR = 0;
  dxCylinder *cylinder = (dxCylinder*)dGeomGetClassData(o1);
  dReal cylRadius = cylinder->radius;
  dReal hl = cylinder->lz;
  dReal sphereRadius;
...
dxCylinder *cylinder1 = (dxCylinder*)dGeomGetClassData(o1);
cylRadius1 = cylinder1->radius;
cylLength1 = cylinder1->lz;
dxCylinder *cylinder2 = (dxCylinder*)dGeomGetClassData(o2);
cylRadius2 = cylinder2->radius;
cylLength2 = cylinder2->lz;
...
{
  dxCylinder *cylinder = (dxCylinder*)dGeomGetClassData(geom);
  dReal radius = cylinder->radius;
  dReal lz = cylinder->lz;
