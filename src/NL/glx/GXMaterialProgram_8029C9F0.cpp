...
GXMaterialProgram_8029C9F0* GXMaterialProgram_8029C9F0::Instance;
bool GXMaterialProgram_8029C9F0::Initialized;

GXMaterialParameter GXMaterialProgram_8029C9F0::Parameters[14] = {
...
GXMaterialProgram_8029C9F0::GXMaterialProgram_8029C9F0()
{
    Instance = this;
...
void GXMaterialProgram_8029C9F0::Initialize()
{
    if (Initialized)
        return;
    Initialized = true;
...
void GXMaterialProgram_8029C9F0::Configure(glModelPacket*)
{
}

void GXMaterialProgram_8029C9F0::ConfigureVertexFormat(bool indexed)
{
    GXClearVtxDesc();
...
void GXMaterialProgram_8029C9F0::BindVertexArrays(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029C9F0::DrawIndexed(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029C9F0::DrawDirect(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029C9F0::BindParameters(const glModelPacket* packet)
{
...
const GXMaterialParameter* GXMaterialProgram_8029C9F0::GetParameters()
{
    return Parameters;
}
