...
GXMaterialProgram_8029E8F8* GXMaterialProgram_8029E8F8::Instance;
bool GXMaterialProgram_8029E8F8::Initialized;

GXMaterialParameter GXMaterialProgram_8029E8F8::Parameters[9] = {
...
GXMaterialProgram_8029E8F8::GXMaterialProgram_8029E8F8()
{
    Instance = this;
...
void GXMaterialProgram_8029E8F8::Initialize()
{
    if (Initialized)
        return;
    Initialized = true;
...
void GXMaterialProgram_8029E8F8::Configure(glModelPacket*)
{
}

void GXMaterialProgram_8029E8F8::ConfigureVertexFormat(bool indexed)
{
    GXClearVtxDesc();
...
void GXMaterialProgram_8029E8F8::BindVertexArrays(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029E8F8::DrawIndexed(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029E8F8::DrawDirect(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029E8F8::BindParameters(const glModelPacket* packet)
{
...
const GXMaterialParameter* GXMaterialProgram_8029E8F8::GetParameters()
{
    return Parameters;
}
