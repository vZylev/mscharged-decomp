...
GXMaterialProgram_8029F5B0* GXMaterialProgram_8029F5B0::Instance;
bool GXMaterialProgram_8029F5B0::Initialized;

GXMaterialParameter GXMaterialProgram_8029F5B0::Parameters[12] = {
...
GXMaterialProgram_8029F5B0::GXMaterialProgram_8029F5B0()
{
    Instance = this;
...
void GXMaterialProgram_8029F5B0::Initialize()
{
    if (Initialized)
        return;
    Initialized = true;
...
void GXMaterialProgram_8029F5B0::Configure(glModelPacket*)
{
}

void GXMaterialProgram_8029F5B0::ConfigureVertexFormat(bool indexed)
{
    GXClearVtxDesc();
...
void GXMaterialProgram_8029F5B0::BindVertexArrays(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029F5B0::DrawIndexed(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029F5B0::DrawDirect(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029F5B0::BindParameters(const glModelPacket* packet)
{
...
const GXMaterialParameter* GXMaterialProgram_8029F5B0::GetParameters()
{
    return Parameters;
}
