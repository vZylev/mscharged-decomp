...
GXMaterialProgram_8029BC9C* GXMaterialProgram_8029BC9C::Instance;
bool GXMaterialProgram_8029BC9C::Initialized;

GXMaterialParameter GXMaterialProgram_8029BC9C::Parameters[6] = {
    { 0x69F44DC5, 0x01010103, 0 },
    { 0xEBAF55D2, 0x01010103, 8 },
    { 0x80968AEB, 0x01010103, 16 },
    { 0x0658BB38, 0x01010101, 24 },
    { 0x8E10B600, 0x01010102, 28 },
    { 0x26839970, 0x01010102, 32 },
};

GXMaterialProgram_8029BC9C::GXMaterialProgram_8029BC9C()
{
    Instance = this;
...
void GXMaterialProgram_8029BC9C::Initialize()
{
    if (Initialized)
        return;
    Initialized = true;
...
void GXMaterialProgram_8029BC9C::Configure(glModelPacket*)
{
}

void GXMaterialProgram_8029BC9C::ConfigureVertexFormat(bool indexed)
{
    GXClearVtxDesc();
...
void GXMaterialProgram_8029BC9C::BindVertexArrays(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029BC9C::DrawIndexed(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029BC9C::DrawDirect(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029BC9C::BindParameters(const glModelPacket* packet)
{
...
const GXMaterialParameter* GXMaterialProgram_8029BC9C::GetParameters()
{
    return Parameters;
}
