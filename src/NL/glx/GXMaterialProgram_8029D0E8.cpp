...
GXMaterialProgram_8029D0E8* GXMaterialProgram_8029D0E8::Instance;
bool GXMaterialProgram_8029D0E8::Initialized;

GXMaterialParameter GXMaterialProgram_8029D0E8::Parameters[10] = {
...
GXMaterialProgram_8029D0E8::GXMaterialProgram_8029D0E8()
{
    Instance = this;
...
void GXMaterialProgram_8029D0E8::Initialize()
{
    if (Initialized)
        return;
    Initialized = true;
...
void GXMaterialProgram_8029D0E8::Configure(glModelPacket*)
{
}

void GXMaterialProgram_8029D0E8::ConfigureVertexFormat(bool indexed)
{
    GXClearVtxDesc();
...
void GXMaterialProgram_8029D0E8::BindVertexArrays(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029D0E8::DrawIndexed(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029D0E8::DrawDirect(const glModelPacket* packet)
{
...
void GXMaterialProgram_8029D0E8::BindParameters(const glModelPacket* packet)
{
...
const GXMaterialParameter* GXMaterialProgram_8029D0E8::GetParameters()
{
    return Parameters;
}
