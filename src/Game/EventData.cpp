...
#define DEFINE_EVENT_POOL(address, size)       \
    ...
    SlotPool<UnidentifiedEventPoolData_##address> lbl_##address(16, 16)

SlotPool<CollisionPlayerPlayerData> gCollisionPlayerPlayerDataPool(16, 16);
SlotPool<CollisionChainPlayerData> gCollisionChainPlayerDataPool(16, 16);
DEFINE_EVENT_POOL(805712A8, 0x08);
DEFINE_EVENT_POOL(805712D0, 0x0C);
DEFINE_EVENT_POOL(805712F8, 0x08);
SlotPool<CollisionChainPowerupData> gCollisionChainPowerupDataPool(16, 16);
...
SlotPool<CollisionBallChainData> gCollisionBallChainDataPool(16, 16);
...
SlotPool<ShotAtGoalData> gShotAtGoalDataPool(16, 16);
...
SlotPool<PlayerAttackData> lbl_80571960(16, 16);
...
{
    gCollisionPlayerPlayerDataPool.FreeBlocks();
    gCollisionChainPlayerDataPool.FreeBlocks();
    lbl_805712A8.FreeBlocks();
    lbl_805712D0.FreeBlocks();
    lbl_805712F8.FreeBlocks();
    gCollisionChainPowerupDataPool.FreeBlocks();
    ...
    gCollisionBallChainDataPool.FreeBlocks();
    ...
    gShotAtGoalDataPool.FreeBlocks();
