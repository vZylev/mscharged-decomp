...
// Only the fields read by this unit are known for the NPC object that the
// powerup wrapper and the ball carrier radius refer to.
struct UnidentifiedObject_801B535C
{
    /* 0x00 */ u8 mUnidentified000[0x2C];
    /* 0x2C */ PhysicsSphere* mUnidentified02C;
    /* 0x30 */ u8 mUnidentified030[0x18];
    /* 0x48 */ nlVector3 mUnidentified048;
    /* 0x54 */ u8 mUnidentified054[0x18];
    /* 0x6C */ nlVector3 mUnidentified06C;
    /* 0x78 */ u8 mUnidentified078[0x8];
    /* 0x80 */ PhysicsSphere* mUnidentified080;
};
...
static float lbl_806DB4D8 = 0.5f;

nlList<UnidentifiedAvoidanceObject> lbl_806E0BA8(0, 0);
int lbl_806E0BB0;
...
UnidentifiedAvoidanceObject::UnidentifiedAvoidanceObject(int type)
{
    int nIndex = AvoidableEnumToIndex((eAvoidableThings)type);
    mTweaks = sUnidentifiedTweaks[nIndex];
    mType = type;
    nlListAddEnd(&lbl_806E0BA8.m_pStart, &lbl_806E0BA8.m_pEnd, this);
    mUnidentified008 = lbl_806E0BB0;
    lbl_806E0BB0++;
}

UnidentifiedAvoidanceObject::~UnidentifiedAvoidanceObject()
{
    fn_8000F594(this);
    nlListRemoveElement(&lbl_806E0BA8.m_pStart, this, &lbl_806E0BA8.m_pEnd);
}

int fn_8000CEF8(eAvoidableThings avoidable)
{
    return AvoidableEnumToIndex(avoidable);
}

int fn_8000CFD4(int index)
{
...
bool UnidentifiedAvoidanceObject::UnidentifiedVirtual20(
...
bool UnidentifiedAvoidanceObject::UnidentifiedVirtual1C(
...
const nlVector3& UnidentifiedAvoidanceFielder_804F4840::GetPosition()
{
    return m_pFielder->m_v3Position;
}

const nlVector3& UnidentifiedAvoidanceFielder_804F4840::GetVelocity()
{
    return m_pFielder->m_v3Velocity;
}

float UnidentifiedAvoidanceFielder_804F4840::GetRadius()
{
    float fRadius = 0.0f;
...
float UnidentifiedAvoidanceFielder_804F4840::UnidentifiedVirtual18()
{
    float fRadius;
...
bool UnidentifiedAvoidanceFielder_804F4840::UnidentifiedVirtual20(
    UnidentifiedAvoidanceObject* other, float range)
{
    ...
    {
        pOther = ((UnidentifiedAvoidanceFielder_804F4840*)other)->m_pFielder;
        nOtherIndex = pOther->mUnidentified120;
    }
    else if (other->mType == AVOID_GOALIES)
    {
        pOther = ((UnidentifiedAvoidancePlayer_804F4810*)other)->m_pPlayer;
        nOtherIndex = pOther->mUnidentified120;
    }
    if (range <= 0.0f)
    {
    ...
    {
        return UnidentifiedAvoidanceObject::UnidentifiedVirtual20(other, range);
    }
}

float UnidentifiedAvoidanceFielder_804F4840::UnidentifiedVirtual28(
    UnidentifiedAvoidanceObject* other)
{
    float fSkill = fn_800A636C(lbl_806E0E00)->Off_Avoidance->fn_800A0D6C();
    ...
    case AVOID_GOALIES:
        if (m_pFielder->IsOnSameTeam(
                ((UnidentifiedAvoidancePlayer_804F4810*)other)->m_pPlayer))
        {
            fStrength *= 0.5f;
        }
    ...
    {
        UnidentifiedAvoidancePolygon_804F4750* pPolygon
            = (UnidentifiedAvoidancePolygon_804F4750*)other;
    ...
    {
        switch (((UnidentifiedAvoidancePatch_804F4780*)other)->m_pPatch->m_Type)
        {
        case 1:
        case 8:
        case 9:
...
float UnidentifiedAvoidanceFielder_804F4840::UnidentifiedVirtual24(
    UnidentifiedAvoidanceObject* other)
{
    switch (other->mType)
    {
...
const nlVector3& UnidentifiedAvoidancePlayer_804F4810::GetPosition()
{
    return m_pPlayer->m_v3Position;
}

const nlVector3& UnidentifiedAvoidancePlayer_804F4810::GetVelocity()
{
    return m_pPlayer->m_v3Velocity;
}

float UnidentifiedAvoidancePlayer_804F4810::GetRadius()
{
    float fRadius;
...
const nlVector3& UnidentifiedAvoidancePowerup_804F47E0::GetPosition()
{
    if (m_pPowerup != 0)
    {
        return m_pPowerup->m_v3Position;
    }
    if (mUnidentified018 != 0)
    {
        return mUnidentified018->mUnidentified048;
    }
    return v3Zero;
}

const nlVector3& UnidentifiedAvoidancePowerup_804F47E0::GetVelocity()
{
    if (m_pPowerup != 0)
    {
    ...
    if (mUnidentified018 != 0)
    {
        return mUnidentified018->mUnidentified06C;
    }
    return v3Zero;
}

float UnidentifiedAvoidancePowerup_804F47E0::GetRadius()
{
    float fRadius = 0.0f;
    if (m_pPowerup != 0)
    {
    ...
    if (mUnidentified018 != 0)
    {
        return mUnidentified018->mUnidentified080->GetRadius();
    }
    return fRadius;
}

bool UnidentifiedAvoidancePowerup_804F47E0::UnidentifiedVirtual2C()
{
...
const nlVector3& UnidentifiedAvoidancePoint_804F47B0::GetPosition()
{
    return mPosition;
}

const nlVector3& UnidentifiedAvoidancePoint_804F47B0::GetVelocity()
{
    return v3Zero;
}

float UnidentifiedAvoidancePoint_804F47B0::GetRadius()
{
    return mRadius;
}

const nlVector3& UnidentifiedAvoidancePatch_804F4780::GetPosition()
{
    return m_pPatch->GetPosition();
}

const nlVector3& UnidentifiedAvoidancePatch_804F4780::GetVelocity()
{
...
float UnidentifiedAvoidancePatch_804F4780::GetRadius()
{
...
bool UnidentifiedAvoidancePatch_804F4780::UnidentifiedVirtual2C()
{
...
static inline void InitPolygon(UnidentifiedAvoidancePolygon_804F4750* pPolygon)
{
    for (int i = 0; i < 4; i++)
    {
...
static inline void BuildPolygon(UnidentifiedAvoidancePolygon_804F4750* pPolygon,
...
UnidentifiedAvoidancePolygon_804F4750::UnidentifiedAvoidancePolygon_804F4750(
    int mode, const nlVector3& a, const nlVector3& b, float width)
    : UnidentifiedAvoidanceObject(AVOID_SIDELINES)
{
    InitPolygon(this);
...
const nlVector3& UnidentifiedAvoidancePolygon_804F4750::GetPosition()
{
...
bool UnidentifiedAvoidancePolygon_804F4750::UnidentifiedVirtual1C(
    const nlVector3& target, nlVector3& point, nlVector3& dir)
{
    int aFront[2] = { -1, -1 };
    int* pFront = aFront;
...
bool UnidentifiedAvoidancePolygon_804F4750::UnidentifiedVirtual20(
    UnidentifiedAvoidanceObject* other, float range)
{
    nlVector3 v3Point;
    nlVector3 v3Dir;
