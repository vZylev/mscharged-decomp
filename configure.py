...
config.libs = [
    {
        ...
        "objects": [
            ...
            Object(Matching, "Game/GameTweaksManager.cpp", extra_cflags=["-use_lmw_stmw off", "-sym on"]),
            ...
            Object(NonMatching, "Game/ReplayManager.cpp", cflags=cflags_game_deferred, extra_cflags=["-ipa file"]),
            Object(Matching, "Game/RumbleActions.cpp"),
            ...
            Object(NonMatching, "Game/AI/DesirePass.cpp", extra_cflags=["-ipa file"]),
            ...
            Object(NonMatching, "Game/FE/fePopupMenu.cpp", extra_cflags=["-ipa file"]),
            ...
            Object(NonMatching, "Game/FE/MatchSummary.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "Game/FE/OnlineRanking.cpp", extra_cflags=["-ipa file", "-sym on"]),
            ...
            Object(NonMatching, "Game/FE/Overlay/OverlayHandlerChallengePreview.cpp", extra_cflags=["-ipa file"]),
            ...
            Object(NonMatching, "Game/SH/SHCupKnockout.cpp", cflags=cflags_game_deferred, extra_cflags=["-ipa file", "-sym on"]),
            ...
            Object(NonMatching, "Game/SH/SHLoading.cpp", extra_cflags=["-inline auto", "-sym on", "-ipa file"]),
            ...
            Object(NonMatching, "Game/SH/SHOnlinePlayerCount.cpp", extra_cflags=["-ipa file"]),
            ...
            Object(NonMatching, "Game/SH/SHPausePostGame.cpp", extra_cflags=["-ipa file", "-sym on"]),
            Object(NonMatching, "Game/SH/SHRoadToStrikersCupHub.cpp", cflags=cflags_game, extra_cflags=["-ipa file"]),
            Object(NonMatching, "Game/SH/SHStadiumSelect.cpp", extra_cflags=["-inline auto", "-inline deferred", "-ipa file"]),
            ...
            Object(NonMatching, "Game/SH/SHStrikerTimesBase.cpp", extra_cflags=["-ipa file"]),
            Object(Matching, "Game/SH/SHStrikerTimesChallenge.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "Game/SH/SHTitleScreen.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "Game/SH/tu_8025BD7C.cpp"),
