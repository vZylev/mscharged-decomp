...
config.libs = [
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "Game/tu_80009B88.cpp"),
            Object(NonMatching, "Game/AI/tu_8000CD44.cpp", extra_cflags=["-ipa file", "-sym on"]),
            ...
            Object(NonMatching, "unclassified/tu_80073C98.cpp", extra_cflags=["-use_lmw_stmw off", "-ipa file"]),
            ...
            Object(NonMatching, "Game/AI/DesireReceivePass.cpp"),
            ...
            Object(NonMatching, "Game/Audio/tu_800ED8B8.cpp"),
            ...
            Object(NonMatching, "Game/Camera/DebugCam.cpp", cflags=cflags_game_deferred),
            ...
            Object(NonMatching, "Game/DB/StatsTracker.cpp"),
            ...
            Object(NonMatching, "Game/DB/tu_8010A40C.cpp"),
            ...
            Object(NonMatching, "Game/Render/tu_80271960.cpp"),
            ...
            Object(NonMatching, "Game/Render/tu_80276264.cpp"),
            Object(NonMatching, "Game/Render/tu_80278EA4.cpp"),
            ...
            Object(Matching, "NL/tu_802A99D8.cpp", extra_cflags=["-i src/zlib"]),
            ...
            Object(NonMatching, "NL/nlConfig.cpp", extra_cflags=["-ipa file"]),
            Object(Matching, "NL/nlDebugFile.cpp"),
            Object(NonMatching, "NL/tu_802B1A30.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "NL/tu_802B2518.cpp", extra_cflags=["-ipa file"]),
            Object(Matching, "NL/nlFile.cpp"),
            Object(NonMatching, "NL/nlFileGC.cpp", extra_cflags=["-inline nobottomup"]),
            Object(NonMatching, "NL/tu_802B3C28.cpp", extra_cflags=["-i src/zlib"]),
            Object(NonMatching, "NL/tu_802B41B4.cpp"),
            ...
            Object(Equivalent, "NL/utility.cpp", cflags=cflags_game_deferred),
            ...
            Object(Matching, "NL/plat/tu_802BFF14.cpp", extra_cflags=["-sym on"]),
            Object(Matching, "NL/plat/tu_802C02C0.cpp"),
            Object(NonMatching, "NL/plat/tu_802C06D4.cpp"),
            ...
            Object(NonMatching, "Game/UnidentifiedTweakValue_8052BED0.cpp"),
            Object(Matching, "Game/TweakValue.cpp"),
            Object(NonMatching, "Game/TweakEntry.cpp"),
            Object(NonMatching, "Game/tu_802C6224.cpp"),
            Object(NonMatching, "Game/Replay.cpp"),
            ...
            Object(NonMatching, "unclassified/tu_802B9568.cpp"),
            Object(NonMatching, "unclassified/tu_802BAE84.cpp"),
            Object(NonMatching, "Game/Debug/ShapeRender.cpp"),
            Object(Matching, "NL/nlEndian.cpp"),
            Object(NonMatching, "NL/gl/glDraw2.cpp", extra_cflags=["-ipa file"]),
            ...
            Object(NonMatching, "Game/Render/tu_802D818C.cpp"),
            Object(NonMatching, "Game/Render/tu_802D88F4.cpp"),
            Object(NonMatching, "Game/Render/tu_802DAEE0.cpp"),
            Object(NonMatching, "Game/Render/tu_802DB930.cpp"),
            Object(NonMatching, "Game/Render/tu_802DCDB4.cpp"),
            Object(NonMatching, "NL/gl/glTarget.cpp"),
            Object(NonMatching, "NL/gl/glTexture.cpp"),
            Object(NonMatching, "NL/gl/tu_802CE0A4.cpp"),
            Object(NonMatching, "NL/gl/glView.cpp"),
            Object(NonMatching, "NL/gl/tu_802D0458.cpp"),
            Object(Matching, "NL/gl/gl.cpp"),
            Object(Matching, "NL/gl/glModel.cpp"),
            Object(Matching, "NL/gl/tu_802CC370.cpp"),
            ...
            Object(NonMatching, "NL/gl/tu_80364020.cpp"),
            Object(NonMatching, "NL/plat/tu_80364118.cpp"),
            Object(NonMatching, "NL/plat/tu_80364604.cpp"),
            Object(NonMatching, "NL/plat/cPlatPad.cpp"),
            Object(NonMatching, "NL/plat/tu_803648EC.cpp"),
            Object(NonMatching, "NL/plat/tu_80364E5C.cpp"),
            Object(NonMatching, "NL/plat/tu_80365488.cpp"),
            Object(NonMatching, "NL/plat/tu_80365E84.cpp", extra_cflags=["-ipa file"]),
            Object(Matching, "NL/gl/tu_80368E00.cpp"),
            Object(NonMatching, "Game/GL/GLInventory.cpp", extra_cflags=["-inline depth=3"]),
            Object(Matching, "Game/GL/tu_802D38A4.cpp"),
            ...
            Object(NonMatching, "Game/Render/tu_802D4290.cpp"),
            Object(NonMatching, "NL/glx/glxLoadModel.cpp"),
            Object(NonMatching, "NL/glx/tu_8036A800.cpp"),
            ...
            Object(Matching, "NL/glx/tu_8036D774.cpp"),
            Object(NonMatching, "NL/glx/tu_8036D894.cpp"),
            ...
            Object(Matching, "NL/gl/tu_802A15D4.cpp"),
            Object(Matching, "Game/GL/ModelWriter_802A1BF4.cpp"),
            ...
            Object(NonMatching, "Game/Drawable/DrawableDaisyFist.cpp", extra_cflags=["-ipa file"]),
            ...
            Object(NonMatching, "unclassified/tu_80197120.cpp", cflags=cflags_game),
            Object(Matching, "unclassified/tu_80199880.cpp", cflags=cflags_game),
            ...
            Object(Matching, "unclassified/tu_8019D6B4.cpp", cflags=cflags_game),
            Object(NonMatching, "Game/Render/depthoffield.cpp"),
            Object(NonMatching, "Game/Render/ElectricFence.cpp", cflags=cflags_game),
            ...
            Object(NonMatching, "Game/Render/NPCManager.cpp"),
            Object(NonMatching, "Game/Render/ShootToScoreArrow.cpp"),
            Object(NonMatching, "unclassified/tu_801AC30C.cpp"),
            Object(NonMatching, "unclassified/tu_801AD15C.cpp"),
            Object(NonMatching, "Game/Render/AttackSideIndicators_801AE0C4.cpp"),
            ...
            Object(Matching, "Game/Physics/LoadablePhysicsMesh.cpp", cflags=cflags_game_deferred),
            ...
            Object(NonMatching, "Game/Physics/PhysicsFakeBall.cpp"),
            ...
            Object(NonMatching, "Game/Task/BeginFrameTask.cpp"),
            ...
            Object(NonMatching, "Game/NetworkSocket_801246E4.cpp"),
            ...
            Object(NonMatching, "Game/NetworkLobby.cpp"),
            Object(NonMatching, "Game/tu_801360A4.cpp"),
            Object(Matching, "Game/Pad/FlickDetection.cpp", cflags=cflags_game_deferred),
            Object(NonMatching, "Game/PadActions.cpp", cflags=cflags_game_deferred),
            ...
            Object(NonMatching, "Game/Effects/EmissionManager.cpp"),
            Object(NonMatching, "Game/Audio/Transition_802F2110.cpp"),
            Object(NonMatching, "Game/Audio/AudioBankTable_802EB644.cpp"),
            Object(NonMatching, "Game/Audio/AudioRuntimeGroup_802F98F4.cpp", extra_cflags=["-ipa file"]),
            ...
            Object(NonMatching, "Game/Audio/tu_8035952C.cpp"),
            Object(NonMatching, "Game/Audio/tu_80359D74.cpp"),
            Object(NonMatching, "Game/Audio/tu_8035A9E0.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "Game/Audio/tu_8035B220.cpp"),
            Object(NonMatching, "Game/Audio/AudioBackend_8035B8E8.cpp"),
            Object(NonMatching, "Game/Audio/Plat3dSoundSrc.cpp"),
            Object(NonMatching, "Game/Audio/AudioResourcePlatform_8035DE28.cpp"),
            Object(NonMatching, "Game/Audio/AudioSource_8035EF08.cpp"),
            Object(NonMatching, "Game/Audio/AudioEffects_803622F0.cpp"),
            Object(NonMatching, "Game/Audio/Reverb.cpp"),
            ...
            Object(NonMatching, "Game/HBMManager_8024795C.cpp"),
            Object(NonMatching, "unclassified/tu_802492E4.cpp", extra_cflags=["-inline noauto"]),
            Object(NonMatching, "unclassified/tu_8024F4E0.cpp"),
            Object(NonMatching, "unclassified/tu_80252180.cpp"),
            Object(NonMatching, "unclassified/tu_80254084.cpp"),
            Object(NonMatching, "unclassified/tu_802582C4.cpp"),
            Object(NonMatching, "unclassified/tu_80259B88.cpp"),
            Object(NonMatching, "unclassified/tu_8025BE74.cpp"),
            Object(NonMatching, "unclassified/tu_8025D170.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "unclassified/tu_80260990.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "unclassified/tu_80261DF0.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "unclassified/tu_80262B54.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "unclassified/tu_802639C4.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "unclassified/tu_80264E98.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "unclassified/tu_802672D4.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "unclassified/tu_8026B10C.cpp"),
            Object(NonMatching, "unclassified/tu_806E1908.cpp"),
            Object(NonMatching, "unclassified/tu_8026F444.cpp"),
            ...
            Object(NonMatching, "Game/FE/feMusic.cpp", cflags=cflags_game_deferred),
            ...
            Object(NonMatching, "Game/FE/tu_802FA1C4.cpp"),
            Object(Matching, "Game/FE/feButtonComponent.cpp"),
            Object(Matching, "Game/FE/feFontResource.cpp"),
            Object(NonMatching, "Game/FE/feInput.cpp", extra_cflags=["-inline depth=3"]),
            ...
            Object(NonMatching, "unclassified/tu_80206CE4.cpp"),
            ...
            Object(NonMatching, "unclassified/tu_802141FC.cpp", cflags=cflags_game_deferred),
            Object(NonMatching, "unclassified/tu_80214DF8.cpp", cflags=cflags_game_deferred),
            Object(NonMatching, "unclassified/tu_80216CB0.cpp", cflags=cflags_game_deferred),
            Object(NonMatching, "Game/SH/SHChooseSides.cpp"),
            Object(NonMatching, "unclassified/tu_8022EF84.cpp"),
            Object(NonMatching, "unclassified/tu_80245F04.cpp", cflags=cflags_game_deferred),
            Object(NonMatching, "Game/SH/SHSceneBase.cpp"),
            Object(Matching, "unclassified/tu_80219248.cpp"),
            Object(NonMatching, "unclassified/tu_802196B0.cpp"),
            Object(NonMatching, "unclassified/tu_80300104.cpp"),
            Object(NonMatching, "Game/FE/tlComponent.cpp"),
            Object(Matching, "Game/FE/tu_80301F3C.cpp"),
            Object(Matching, "Game/FE/tu_80301FAC.cpp"),
            ...
            Object(Matching, "NL/UnknownHashTable_80307620.cpp", extra_cflags=["-sym on"]),
            ...
            Object(NonMatching, "Game/AI/tu_803115F4.cpp", cflags=[*cflags_game, "-char signed"]),
            ...
            Object(NonMatching, "Game/Triggers/AnimTagScript.cpp", cflags=cflags_game),
            Object(Matching, "Game/Triggers/BinaryTriggerFile.cpp", cflags=cflags_game_deferred),
            Object(Matching, "NL/blowfish.cpp"),
            Object(Matching, "Game/MessageSerializer_80323638.cpp"),
            Object(NonMatching, "Game/NetworkRandom_803236CC.cpp"),
            Object(Matching, "Game/NetworkDiagnostics_803239A8.cpp"),
            Object(NonMatching, "Game/NetworkDebug_80323B2C.cpp"),
            Object(NonMatching, "unclassified/tu_8032452C.cpp"),
            Object(NonMatching, "unclassified/tu_803263E4.cpp"),
            Object(NonMatching, "unclassified/tu_80326844.cpp", extra_cflags=["-ipa file"]),
            Object(NonMatching, "unclassified/tu_8032B6D4.cpp"),
            Object(Matching, "Game/MessageRegistry_8032C7D0.cpp"),
            Object(NonMatching, "Game/NetworkTransport_8032CA4C.cpp"),
            Object(NonMatching, "unclassified/tu_80330430.cpp"),
            Object(Matching, "Game/NetworkMessages_80330978.cpp"),
            Object(NonMatching, "Game/NetworkMessages_80330BC8.cpp"),
            Object(NonMatching, "Game/NetworkInput_80331668.cpp"),
            Object(Matching, "Game/DetermDataEvent.cpp"),
            Object(NonMatching, "unclassified/tu_80331BE4.cpp"),
            Object(NonMatching, "unclassified/tu_80332770.cpp"),
            Object(NonMatching, "unclassified/tu_80332DC0.cpp"),
            Object(NonMatching, "unclassified/tu_80336B2C.cpp"),
            Object(NonMatching, "unclassified/tu_80338898.cpp"),
            Object(Matching, "unclassified/tu_80338BF0.cpp"),
            Object(NonMatching, "Game/DebugWriteCache.cpp"),
            Object(NonMatching, "Game/Transitions/ColourBlendScreenTransition.cpp"),
            Object(NonMatching, "Game/Transitions/ModelTransition.cpp"),
