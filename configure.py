...
config.libs = [
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "Game/TerrainTweaks.cpp", extra_cflags=["-ipa file"]),
            ...
            Object(NonMatching, "Game/FE/Overlay/OverlayHandlerChallengePreview.cpp", cflags=cflags_game_deferred),
            ...
            Object(NonMatching, "Game/SH/SHRoadToStrikersCupHub.cpp", cflags=cflags_game),
            ...
            Object(NonMatching, "Game/FE/tlComponent.cpp", extra_cflags=["-ipa file"]),
